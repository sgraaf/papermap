...
*This document is intended for AI assistants (like Claude) to understand the PaperMap codebase structure, development workflows, and conventions. Keep it updated as the project evolves.*
