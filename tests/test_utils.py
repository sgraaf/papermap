...
def lon_lat_x_y_zoom(func: Callable) -> Callable:
    return pytest.mark.parametrize(
        "lat,lon,x,y,zoom",
        (
            (13.736717, 100.523186, 24.9353943, 14.7670899, 5),  # Bangkok
            (40.416775, -3.703790, 62.6830969, 48.2640937, 7),  # Madrid
            (19.432608, -99.133209, 0.22463, 0.4449548, 0),  # Mexico City
            (49.246292, -123.116226, 2588.8437589, 5609.5000923, 14),  # Vancouver
        ),
    )(func)
